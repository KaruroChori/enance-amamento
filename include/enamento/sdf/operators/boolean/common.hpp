...
namespace sdf{
    ...
    namespace{namespace impl_base{
        ...
        struct Common : utils::binary_op<L, R>{
            ...
            constexpr inline void traits(const traits_t& fromA, const traits_t& fromB, traits_t& to) const{
                ...
                to.outer_box={ max(fromA.outer_box.min,fromB.outer_box.min), min(fromA.outer_box.max,fromB.outer_box.max)  };
            }
            ...
            constexpr inline static const char* _name = "Common";
